defmodule AiDrudgeWeb.PageHTML do
  @moduledoc """
...
<div class="pt-5 pb-5">Enter a Statement and chatgpt will analise it and give a breakdown for the frontpage.</div>
    <form action="/search" class="max-w-[480px] w-full px-8" method="post">
        <div class="relative">
            <input type="text" name="query" class="w-full border h-12 shadow p-4 rounded-full dark:text-gray-800 dark:border-gray-700 dark:bg-gray-200" placeholder="Ask">
            <button type="submit">
